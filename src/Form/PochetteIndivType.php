...
/**
 * FormType unifié pour PochetteIndiv
 * Utilisé pour création rapide ET édition
 * Pattern DRY : Un seul FormType par entité
 */
class PochetteIndivType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('libelle', TextType::class, [
                ...
                'attr' => [
                    'class' => 'form-control',
                    'placeholder' => 'Ex: Pochette plastique 10x15',
                    'maxlength' => 200,
                    'autofocus' => $options['autofocus']
                ],
                'help' => 'Nom unique pour identifier cette pochette individuelle'
            ])
            ->add('description', TextareaType::class, [
                ...
                'help' => 'Description détaillée de la pochette individuelle'
            ])
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => PochetteIndiv::class,
            'show_submit' => true,
