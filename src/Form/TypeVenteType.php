...
/**
 * FormType unifié pour TypeVente
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('libelle', TextType::class, [
                ...
                'required' => true,
                'constraints' => [
                    new NotBlank(['message' => 'Le type de vente est obligatoire']),
                    new Length([
                        'min' => 2,
                        'max' => 255,
                ...
                'attr' => [
                    'class' => 'form-control',
                    'placeholder' => 'Ex: Vente flash, Commande groupée...',
                    'autofocus' => $options['autofocus']
                ],
                'help' => 'Décrivez le mode de commercialisation'
            ])
            ->add('description', TextareaType::class, [
                ...
                'attr' => [
                    'class' => 'form-control',
                    'rows' => 3,
                    'placeholder' => 'Décrivez les modalités de ce type de vente...'
                ],
                'help' => 'Détails sur le processus de vente et de livraison'
            ])
